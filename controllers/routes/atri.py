...
class Atri:
	def __init__(self, state: Any):
		...
		self.navbar__buttons = state["navbar__buttons"]
		self.navbar__links = state["navbar__links"]
		self.navbar__linksLinks = state["navbar__linksLinks"]
		self.hero = state["hero"]
		self.hero__text = state["hero__text"]
		self.hero__textButtons = state["hero__textButtons"]
		self.Div13 = state["Div13"]
		self.hero__design = state["hero__design"]
		...
		self.hero__textSubtitle = state["hero__textSubtitle"]
		self.Button3 = state["Button3"]
		self.Button5 = state["Button5"]
		self.hero__textHightlight = state["hero__textHightlight"]
		self.hero__textTitle = state["hero__textTitle"]
	...
	@property
	def navbar__buttons(self):
		self._getter_access_tracker["navbar__buttons"] = {}
		return self._navbar__buttons
	@navbar__buttons.setter
	def navbar__buttons(self, new_state):
		self._setter_access_tracker["navbar__buttons"] = {}
		global default_state
		self._navbar__buttons = Flex(new_state, default_state["navbar__buttons"])

	@property
	def navbar__links(self):
		self._getter_access_tracker["navbar__links"] = {}
		return self._navbar__links
	@navbar__links.setter
	def navbar__links(self, new_state):
		self._setter_access_tracker["navbar__links"] = {}
		global default_state
		self._navbar__links = Flex(new_state, default_state["navbar__links"])

	@property
	def navbar__linksLinks(self):
		self._getter_access_tracker["navbar__linksLinks"] = {}
		return self._navbar__linksLinks
	@navbar__linksLinks.setter
	def navbar__linksLinks(self, new_state):
		self._setter_access_tracker["navbar__linksLinks"] = {}
		global default_state
		self._navbar__linksLinks = Flex(new_state, default_state["navbar__linksLinks"])
	...
	def hero(self, new_state):
		...
		global default_state
		self._hero = Flex(new_state, default_state["hero"])

	@property
	def hero__text(self):
		self._getter_access_tracker["hero__text"] = {}
		return self._hero__text
	@hero__text.setter
	def hero__text(self, new_state):
		self._setter_access_tracker["hero__text"] = {}
		global default_state
		self._hero__text = Flex(new_state, default_state["hero__text"])

	@property
	def hero__textButtons(self):
		self._getter_access_tracker["hero__textButtons"] = {}
		return self._hero__textButtons
	@hero__textButtons.setter
	def hero__textButtons(self, new_state):
		self._setter_access_tracker["hero__textButtons"] = {}
		global default_state
		self._hero__textButtons = Flex(new_state, default_state["hero__textButtons"])
	...
	@property
	def hero__design(self):
		self._getter_access_tracker["hero__design"] = {}
		return self._hero__design
	@hero__design.setter
	def hero__design(self, new_state):
		self._setter_access_tracker["hero__design"] = {}
		global default_state
		self._hero__design = Flex(new_state, default_state["hero__design"])
	...
	@property
	def hero__textSubtitle(self):
		self._getter_access_tracker["hero__textSubtitle"] = {}
		return self._hero__textSubtitle
	@hero__textSubtitle.setter
	def hero__textSubtitle(self, new_state):
		self._setter_access_tracker["hero__textSubtitle"] = {}
		global default_state
		self._hero__textSubtitle = TextBox(new_state, default_state["hero__textSubtitle"])
	...
	@property
	def hero__textHightlight(self):
		self._getter_access_tracker["hero__textHightlight"] = {}
		return self._hero__textHightlight
	@hero__textHightlight.setter
	def hero__textHightlight(self, new_state):
		self._setter_access_tracker["hero__textHightlight"] = {}
		global default_state
		self._hero__textHightlight = TextBox(new_state, default_state["hero__textHightlight"])

	@property
	def hero__textTitle(self):
		self._getter_access_tracker["hero__textTitle"] = {}
		return self._hero__textTitle
	@hero__textTitle.setter
	def hero__textTitle(self, new_state):
		self._setter_access_tracker["hero__textTitle"] = {}
		global default_state
		self._hero__textTitle = TextBox(new_state, default_state["hero__textTitle"])
	...
	@property
	def Rating2(self):
		self._getter_access_tracker["Rating2"] = {}
		return self._Rating2
	@Rating2.setter
	def Rating2(self, new_state):
		self._setter_access_tracker["Rating2"] = {}
		global default_state
		self._Rating2 = Rating(new_state, default_state["Rating2"])
	...
	@property
	def Rating3(self):
		self._getter_access_tracker["Rating3"] = {}
		return self._Rating3
	@Rating3.setter
	def Rating3(self, new_state):
		self._setter_access_tracker["Rating3"] = {}
		global default_state
		self._Rating3 = Rating(new_state, default_state["Rating3"])
	...
	def _to_json_fields(self):
		return {
			"navbar": self._navbar,
			"navbar__buttons": self._navbar__buttons,
			"navbar__links": self._navbar__links,
			"navbar__linksLinks": self._navbar__linksLinks,
			"hero": self._hero,
			"hero__text": self._hero__text,
			"hero__textButtons": self._hero__textButtons,
			"Div13": self._Div13,
			"hero__design": self._hero__design,
			"Flex24": self._Flex24,
			"Flex23": self._Flex23,
			"Flex26": self._Flex26,
			"Flex27": self._Flex27,
			...
			"hero__textSubtitle": self._hero__textSubtitle,
			"Button3": self._Button3,
			"Button5": self._Button5,
			"hero__textHightlight": self._hero__textHightlight,
			"hero__textTitle": self._hero__textTitle,
			"Image4": self._Image4,
