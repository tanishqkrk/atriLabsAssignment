useTextBox46Cb, useTextBox47Cb, useImage23Cb, useTextBox48Cb, useTextBox49Cb, useImage24Cb, useTextBox50Cb, useTextBox51Cb, useTextBox52Cb, useImage25Cb, useTextBox53Cb, useTextBox54Cb, useTextBox55Cb, useImage26Cb, useTextBox56Cb, useTextBox57Cb, useTextBox58Cb, useTextBox59Cb, useImage27Cb, useTextBox60Cb, useButton16Cb, useButton17Cb, useImage29Cb, useTextBox61Cb, useTextBox62Cb, useButton18Cb, useButton19Cb, useTextBox63Cb, useTextBox64Cb, useTextBox65Cb, useImage30Cb, useImage33Cb, useRating2Cb, useTextBox69Cb, useTextBox70Cb, useImage34Cb, useTextBox71Cb, useTextBox72Cb, useButton20Cb, useButton21Cb, useTextBox73Cb, useButton32Cb, useTextBox76Cb, useTextBox77Cb, useTextBox78Cb, useImage36Cb, useTextBox82Cb, useTextBox83Cb, useImage38Cb, useTextBox84Cb, useTextBox85Cb, useImage39Cb, useImage50Cb, useTextBox106Cb, useTextBox107Cb, useImage51Cb, useTextBox108Cb, useTextBox109Cb, useTextBox118Cb, useImage55Cb, useTextBox115Cb, useImage56Cb, useTextBox116Cb, useTextBox117Cb, useImage57Cb, useTextBox129Cb, useInput12Cb, useTextBox130Cb, useInput13Cb, useTextBox134Cb, useInput17Cb, useTextBox135Cb, useInput18Cb, useTextBox136Cb, useInput19Cb, useTextBox137Cb, useInput20Cb, useTextBox139Cb, useInput24Cb, useButton25Cb, useButton33Cb, useTextBox140Cb, useImage58Cb, useImage59Cb, useImage60Cb, useImage61Cb, useImage62Cb, useImage63Cb, useTextBox141Cb, useRating3Cb, useImage64Cb, useTextBox146Cb, useTextBox147Cb, useTextBox148Cb, useTextBox149Cb, useTextBox150Cb, useTextBox151Cb, useTextBox152Cb, useTextBox153Cb, useTextBox164Cb, useTextBox165Cb, useTextBox166Cb, useTextBox167Cb, useTextBox168Cb, useTextBox169Cb, useTextBox170Cb, useTextBox171Cb, useTextBox163Cb, useImage65Cb, useImage67Cb, useImage68Cb, useImage69Cb } from "../page-cbs/Home";
...
const navbar__buttonsProps = useStore((state)=>state["Home"]["navbar__buttons"]);
const navbar__buttonsIoProps = useIoStore((state)=>state["Home"]["navbar__buttons"]);
const navbar__buttonsCb = usenavbar__buttonsCb()
const navbar__linksProps = useStore((state)=>state["Home"]["navbar__links"]);
const navbar__linksIoProps = useIoStore((state)=>state["Home"]["navbar__links"]);
const navbar__linksCb = usenavbar__linksCb()
const navbar__linksLinksProps = useStore((state)=>state["Home"]["navbar__linksLinks"]);
const navbar__linksLinksIoProps = useIoStore((state)=>state["Home"]["navbar__linksLinks"]);
const navbar__linksLinksCb = usenavbar__linksLinksCb()
...
const hero__textButtonsProps = useStore((state)=>state["Home"]["hero__textButtons"]);
const hero__textButtonsIoProps = useIoStore((state)=>state["Home"]["hero__textButtons"]);
const hero__textButtonsCb = usehero__textButtonsCb()
const Div13Props = useStore((state)=>state["Home"]["Div13"]);
const Div13IoProps = useIoStore((state)=>state["Home"]["Div13"]);
const Div13Cb = useDiv13Cb()
const hero__designProps = useStore((state)=>state["Home"]["hero__design"]);
const hero__designIoProps = useIoStore((state)=>state["Home"]["hero__design"]);
const hero__designCb = usehero__designCb()
...
const hero__textSubtitleProps = useStore((state)=>state["Home"]["hero__textSubtitle"]);
const hero__textSubtitleIoProps = useIoStore((state)=>state["Home"]["hero__textSubtitle"]);
const hero__textSubtitleCb = usehero__textSubtitleCb()
...
const hero__textHightlightProps = useStore((state)=>state["Home"]["hero__textHightlight"]);
const hero__textHightlightIoProps = useIoStore((state)=>state["Home"]["hero__textHightlight"]);
const hero__textHightlightCb = usehero__textHightlightCb()
const hero__textTitleProps = useStore((state)=>state["Home"]["hero__textTitle"]);
const hero__textTitleIoProps = useIoStore((state)=>state["Home"]["hero__textTitle"]);
const hero__textTitleCb = usehero__textTitleCb()
...
<Flex className="p-Home navbar__links bpt" {...navbar__linksProps} {...navbar__linksCb} {...navbar__linksIoProps}>
<Image className="p-Home Image9 bpt" {...Image9Props} {...Image9Cb} {...Image9IoProps}/>
<Flex className="p-Home navbar__linksLinks bpt" {...navbar__linksLinksProps} {...navbar__linksLinksCb} {...navbar__linksLinksIoProps}>
...
<Flex className="p-Home navbar__buttons bpt" {...navbar__buttonsProps} {...navbar__buttonsCb} {...navbar__buttonsIoProps}>
<Button className="p-Home Button1 bpt" {...Button1Props} {...Button1Cb} {...Button1IoProps}/>
<Button className="p-Home Button2 bpt" {...Button2Props} {...Button2Cb} {...Button2IoProps}/>
</Flex>
</Flex>
<Flex className="p-Home hero bpt" {...heroProps} {...heroCb} {...heroIoProps}>
<Flex className="p-Home hero__text bpt" {...hero__textProps} {...hero__textCb} {...hero__textIoProps}>
<Div className="p-Home Div13 bpt" {...Div13Props} {...Div13Cb} {...Div13IoProps}>
<TextBox className="p-Home hero__textTitle bpt" {...hero__textTitleProps} {...hero__textTitleCb} {...hero__textTitleIoProps}/>
<TextBox className="p-Home hero__textHightlight bpt" {...hero__textHightlightProps} {...hero__textHightlightCb} {...hero__textHightlightIoProps}/>
</Div>
<TextBox className="p-Home hero__textSubtitle bpt" {...hero__textSubtitleProps} {...hero__textSubtitleCb} {...hero__textSubtitleIoProps}/>
<Flex className="p-Home hero__textButtons bpt" {...hero__textButtonsProps} {...hero__textButtonsCb} {...hero__textButtonsIoProps}>
<Button className="p-Home Button3 bpt" {...Button3Props} {...Button3Cb} {...Button3IoProps}/>
<Button className="p-Home Button5 bpt" {...Button5Props} {...Button5Cb} {...Button5IoProps}/>
</Flex>
</Flex>
<Flex className="p-Home hero__design bpt" {...hero__designProps} {...hero__designCb} {...hero__designIoProps}>
